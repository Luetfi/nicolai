...
import {
  Home,
  Leistungen,
  FuehrerscheinLudwigsburg,
  FuehrerscheinKlasseB,
        ...
        <Layout>
          <Suspense fallback={<RouteFallback />}>
            <Routes>
              ...
              <Route path="/fuehrerschein-ludwigsburg" element={<FuehrerscheinLudwigsburg />} />
              <Route
                path="/fuehrerschein-klasse-b-ludwigsburg"
                element={<FuehrerscheinKlasseB />}
              />
              <Route
                path="/motorradfuehrerschein-ludwigsburg"
                element={<Motorradfuehrerschein />}
              />
              <Route path="/asf-aufbauseminar-ludwigsburg" element={<AsfAufbauseminar />} />
