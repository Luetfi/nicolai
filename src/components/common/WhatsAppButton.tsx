...
export function WhatsAppButton() {
  return (
    ...
    >
      ...
      <span className="relative flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-[#25D366] hover:bg-[#1ebe57] shadow-xl shadow-green-900/40 transition-all hover:scale-110">
        <svg
