...
export const licenseClasses: LicenseClass[] = [
  ...
  },
  {
    id: 'b196',
    name: 'B196',
    title: 'B196 Schlüsselzahl',
    description: 'Erweiterung der Klasse B für Krafträder bis 125 ccm und 11 kW.',
    requirements: [
  ...
  },
  {
    ...
    description: 'Kombination aus Klasse B und Anhänger über 750 kg bis 3.500 kg zulässiger Gesamtmasse.',
    requirements: [
      'Vorbesitz Klasse B',
...
export const specialServices: SpecialService[] = [
  ...
  {
    id: 'zweirad',
    title: 'Sicherheitstraining Zweirad',
    description: 'Spezielles Training für Motorrad- und Rollerfahrer.',
    details: [
      'Erweiterte Übungen auf dem Übungsplatz',
